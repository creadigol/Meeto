...
public class DisplayCropingImage extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Profile_Activity.mBitmap != null)
            cropImageView.setImageBitmap(Profile_Activity.mBitmap);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonOk:
                Profile_Activity.mBitmapCrop = cropImageView.getCroppedImage();
...
//Convert bitmap to byte array
                ...
                Profile_Activity.mBitmapCrop.compress(Bitmap.CompressFormat.PNG, 0 /*ignored for PNG*/, bos);
